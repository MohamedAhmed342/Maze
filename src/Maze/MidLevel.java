...
//        }
        ...
        drawCircle(gl, 3, Color.YELLOW, a, -51.0 , 200.0 );
        drawCircle(gl, 3, Color.YELLOW, c,  -66.0 , 170.0);
        drawCircle(gl, 3, Color.YELLOW, d, -71.0 , 105.0 );
        drawCircle(gl, 3, Color.YELLOW, e , -16.0 , 15.0 );
        drawCircle(gl, 3, Color.YELLOW, f , -66.0 , -40.0 );

        drawCircle(gl, 3, Color.YELLOW, b, -106.0 , -15.0);
        drawCircle(gl, 3, Color.YELLOW, k, -141.0 , -105.0 );
        drawCircle(gl, 3, Color.YELLOW, l , 59.0 , 105.0 );
        drawCircle(gl, 3, Color.YELLOW, m, 29.0 , 105.0);
        drawCircle(gl, 3, Color.YELLOW, z1, 59.0 , -15.0 );
        drawCircle(gl, 3, Color.YELLOW, z2, 109.0 , -75.0 );
        drawCircle(gl, 3, Color.YELLOW, z3, 109.0 , -105.0 );
        drawCircle(gl, 3, Color.YELLOW, z4, 139.0 , 15.0 );
        drawCircle(gl, 3, Color.YELLOW, z5, 169.0 , 100.0 );
        drawCircle(gl, 3, Color.YELLOW, z6, 169.0 , 220.0 );
        drawCircle(gl, 3, Color.YELLOW, z7, 169.0 , 170.0 );
        drawCircle(gl, 3, Color.YELLOW, z8, 189.0 , -110.0 );
        drawCircle(gl, 3, Color.YELLOW, z9, 249.0 , -105.0 );
        drawCircle(gl, 3, Color.YELLOW, z10, 249.0 , -75.0 );
        drawCircle(gl, 3, Color.YELLOW, z11, 249 , 75.0 );
        ...
        if (buffer_px == -51.0 && buffer_py == 200.0 && a==true ) {//1

            a= false ;
            counter+=10;
        }

        if (buffer_px ==  -66.0 && buffer_py ==170.0 && b==true ) {//2
            b=false ;
            counter+=10;

        }

        if (buffer_px == -71.0 && buffer_py ==105.0 && c==true ) {//3
            c=false ;
            counter+=10;

        }

        if (buffer_px == -16.0 && buffer_py == 15.0 && d==true  ) {//4
            d=false ;
            counter+=10;
        }

        if (buffer_px == -66.0 && buffer_py == -40.0 && f==true  ) {//5
            f=false ;
            counter+=10;
        }

        if (buffer_px == -106.0&& buffer_py == -15.0 && e==true  ) {//6
            e=false ;
            counter+=10;
        }

        if (buffer_px == -141.0 && buffer_py == -15.0 && k==true  ) {//7
            k=false ;
            counter+=10;
        }

        if (buffer_px == 59.0  && buffer_py == 105.0 && l==true  ) {//8
            l=false ;
            counter+=10;
        }

        if (buffer_px == 29.0  && buffer_py == 105.0 && m==true  ) {//9
            m=false ;
            counter+=10;
        }
        if (buffer_px ==59.0 && buffer_py == -15.0 && z1==true  ) {//10
            z1=false ;
            counter+=10;
        }
        if (buffer_px ==109.0  && buffer_py ==-75.0&& z2==true  ) {//11
            z2=false ;
            counter+=10;
        }
        if (buffer_px == 190.0 && buffer_py == -105.0  && z3==true  ) {//12
            z3=false ;
            counter+=10;
        }
        if (buffer_px == 139.0  && buffer_py ==15.0 && z4==true  ) {//13
            z4=false ;
            counter+=10;
        }
        if (buffer_px ==169.0 && buffer_py ==100.0 && z5==true  ) {//14
            z5=false ;
            counter+=10;
        }
        if (buffer_px == 169.0 && buffer_py == 220.0 && z6==true  ) {//15
            z6=false ;
            counter+=10;
        }
        if (buffer_px == 169.0 && buffer_py == 170.0 && z7==true  ) {//16
            z7=false ;
            counter+=10;
        }
        if (buffer_px ==189.0&& buffer_py == -110.0 && z8==true  ) {//17
            z8=false ;
            counter+=10;
        }
        if (buffer_px ==249&& buffer_py == -105.0  && z9==true  ) {//18
            z9=false ;
            counter+=10;
        }
        if (buffer_px == 249.0 && buffer_py == -75.0  && z10==true  ) {//19
            z10=false ;
            counter+=10;
        }
        if (buffer_px == 249.0 && buffer_py == 75.0  && z11==true  ) {//19
            z11=false ;
            counter+=10;
        }
...
//
        ...
        if (px == 294.0 && py == -90.0 || px == 299.0 && py == -90.0 ||  px == 304.0 && py == -90.0 ||  px == 309.0 && py == -90.0  || px == 309.0 && py == -95.0 || px == 309.0 && py == -100.0 || px == 304.0 && py == -100.0  || px == 299.0 && py == -100.0 || px == -294.0 && py == -100.0 ||px == 289.0 && py == -100.0   ) 
